                        ...
                        <div className="modal-body">
                            {!isProcessing ? (
                                <>
                                    ...
                                    >
                                        <i className="la la-cloud-upload text-primary" style={{ fontSize: '50px' }}></i>
                                        <p className="mt-3">
                                            {selectedFile ? selectedFile.name : 'Klik atau seret file PDF/Gambar ke sini'}
                                        </p>
                                        <input 
                                            ref={fileInputRef}
                                            type="file" 
                                ...
                                activeOcrId && (
                                    <OCRTracker 
                                        ...
                                        onFinish={() => {
                                            ...
                                            router.get(`/sales/policy/create?ocr_id=${activeOcrId}`);
                                        }} 
                                    />
                                )
                            )}
